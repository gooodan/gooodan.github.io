      ...
      var render = function render(res) {
        ...
        for (var j = 0, len2 = res.list.length; j < len2; j++) {
          ...
          for (var i = 0, len = data.link.length; i < len; i++) {
            var minSrc = 'https://daomablog.oss-cn-beijing.aliyuncs.com/min_photos/' + data.link[i];
            var src = 'https://daomablog.oss-cn-beijing.aliyuncs.com/photos/' + data.link[i];
          ...
          ulTmpl = ulTmpl + '<section class="archives album post-header"><h1 class="year">' + data.year + ' Year<em>' + data.month + ' Month</em></h1>\
